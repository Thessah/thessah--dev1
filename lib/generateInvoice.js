...
const COMPANY_NAME = process.env.NEXT_PUBLIC_INVOICE_COMPANY_NAME || "Thessah";
...
const COMPANY_CONTACT = process.env.NEXT_PUBLIC_INVOICE_CONTACT || "Email: support@Thessah.com";
...
// Font config for proper AEDrendering and better Unicode support
...
async function ensureUnicodeFont(doc) {
    ...
    try {
        ...
        // If font fails to load, fallback to core font (AEDmay not render)
    }
}

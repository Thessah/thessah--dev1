...
export default function StoreLogin() {
  ...
  useEffect(() => {
    const checkAccess = async () => {
      ...
      // Check if logged in with username/password (stored in localStorage)
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8">
          ...
          {loginMethod === 'username' && (
            <form onSubmit={handleUsernameLogin} className="space-y-4">
              ...
              <div>
                <label htmlFor="password-username" className="block text-sm font-medium text-slate-700 mb-2">
                  Password
                </label>
                <input
